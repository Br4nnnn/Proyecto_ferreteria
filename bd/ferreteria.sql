...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-04-2025 a las 11:16:21
...
(1, 'andres', '235412345', '4123453', 'greasrgh');
...
CREATE TABLE `inventario_productos` (
  ...
  `categoria_producto` enum('herramientas','tornillos','tuercas','pintura','construccion','fontaneria','electronica y cableado','adhesivos','decoracion') NOT NULL,
  `nombre_producto` varchar(50) NOT NULL,
  `precio_proveedor` float(8,2) NOT NULL,
